    ...
    return (
        <>
            <div className='px-[120px] py-[50px]'>
                <h1 className='font-SourceReg  mb-[40px] font-medium text-center text-xl'>Most <span className='font-SourceBold text-xl text-primary'>popular</span> tutorials</h1>
                <div className='flex flex-wrap items-center justify-between'>
                    <div className='max-w-[240px] flex flex-col space-y-2'>
